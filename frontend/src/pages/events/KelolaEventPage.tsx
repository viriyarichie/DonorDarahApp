...
export const KelolaEventPage = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: () =>
      eventService.update(editTarget!.id, {
        name: form.name,
        description: form.description,
        event_date: form.event_date,
        quota: Number(form.quota),
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Buat dan kelola event donor darah PMI
          </p>
        </div>
        <button
          onClick={() => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-red-400 resize-none text-black"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
      ...
      {events.length === 0 ? (
        <EmptyState
          ...
          description="Belum ada event yang dibuat. Klik tombol Tambah Event untuk memulai."
        />
      ) : (
