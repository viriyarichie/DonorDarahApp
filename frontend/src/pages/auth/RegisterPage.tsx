...
import { User, Mail, Lock, Phone, CreditCard, Eye, EyeOff, Calendar } from 'lucide-react';
...
export const RegisterPage = () => {
  const [form, setForm] = useState({
    nik: '', name: '', email: '', phone: '', password: '', password_confirmation: '',
  ...
  const inputClass = (key: string) =>
    `w-full pl-11 pr-4 py-2.5 rounded-xl border text-sm transition-colors outline-none ${
      errors[key] ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-red-400 focus:ring-2 focus:ring-red-100'
    }`;
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">Bergabunglah sebagai pendonor darah PMI</p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <div className="relative">
              ...
              <input id="nik" type="text" maxLength={16} placeholder="Nomor Induk Kependudukan" {...field('nik')} className={inputClass('nik')} required />
            </div>
            {errors.nik && <p className="text-xs text-red-600 mt-1">{errors.nik[0]}</p>}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="name" type="text" placeholder="Nama sesuai KTP" {...field('name')} className={inputClass('name')} required />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="email" type="email" placeholder="contoh@email.com" {...field('email')} className={inputClass('email')} required />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="phone" type="tel" placeholder="08xx-xxxx-xxxx" {...field('phone')} className={inputClass('phone')} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <div className="relative">
                ...
                <input id="birth_date" type="date" {...field('birth_date')} className={inputClass('birth_date')} />
              </div>
            </div>
            <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Minimal 8 karakter" {...field('password')}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Ulangi kata sandi" {...field('password_confirmation')}
                className={inputClass('password_confirmation')} required
              />
            </div>
          </div>
        </div>
      ...
      <p className="text-center text-sm text-gray-500 mt-4">
        Sudah punya akun?{' '}
        <Link to="/login" className="text-red-600 font-semibold hover:text-red-700">Masuk di sini</Link>
      </p>
    </div>
  );
};
